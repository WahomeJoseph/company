...
// Types for select trigger and other components
...
const SelectContent = React.forwardRef<
  ...
  SelectContentProps & { position?: 'popper' | 'item-aligned' }
